...
impl DinoGame {
    ...
    fn draw_enemy(
        ...
        render::draw_cacti_small(
            self,
            enemy.start_x * (render::SIZE as f64),
            271.0 * (render::SIZE as f64),
            &painter,
            ui,
            ctx,
        )?;
    ...
    fn update_game(
        ...
        let (_, painter) = ui.allocate_painter(
            egui::vec2(1300.0_f32.min(200.0 + (self.intro_mode as f32)), 300.0),
            Sense::drag(),
        );
